...
[fc-agent-skill](../fc-agent-skill/SKILL.md) — load it on demand when applying changes; do
...
- Creating/updating one skill or agent with known placement → `fc-agent-skill`
...
4. **Apply** — load `fc-agent-skill` for skill/agent edits. Order: L3 first, L2 next, L1 last
...
- [fc-agent-skill](../fc-agent-skill/SKILL.md) — skill/agent authoring, promotion rules detail
